  ...
  return (
    <Fragment>
      ...
      <div className="welcomeMenu">
        <Link to="!#">
          <img src={chicpeaRecipe} alt="Chic pea dish as icon to add a recipe" />
          <h2>+ Add Recipe</h2>
          <p>
        ...
        <Link to="/ingredients">
          <img src={ingredientBasket} alt="Personal holing an ingredient basket as an icon to organise ingredients" />
          <h2>Organise Ingredient Suppliers</h2>
          <p>Update ingredient prices & compare the market</p>
        </Link>
        <Link to="/account/venues">
          <img src={venueSetup} alt="Man standing at a bar as an icon to complete venue setup" />
